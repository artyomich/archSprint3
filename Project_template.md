...
![диаграмма С4](docs/c4/images/c4_model.png "Диаграмма С4")

# Задание 2. Проектирование микросервисной архитектуры

**Диаграмма контейнеров (Containers)**

![Containers Diagram](docs/c4/images/containers_new.png "Диаграмма контейнеров ")

**Диаграмма компонентов (Components) - регистрация пользователей и домов**

![Диаграмма компонентов](docs/c4/images/user-management.cd.png "Диаграмма компонентов")

**Диаграмма компонентов (Components) - конфигурирование устройств**

![Диаграмма компонентов](docs/c4/images/device-management.cd.png "Диаграмма компонентов")

**Диаграмма компонентов (Components) - управление командами на устройства**

![Диаграмма компонентов](docs/c4/images/commands-management.cd.png "Диаграмма компонентов")

**Диаграмма компонентов (Components) - управление получения данных с устройств**

![Диаграмма компонентов](docs/c4/images/sensors-management.cd.png "Диаграмма компонентов")

**Диаграмма кода (Code)**

![Диаграмма кода](docs/c4/images/code.png "Диаграмма кода")

# Задание 3. Разработка ER-диаграммы

![Диаграмма отношений сущностей](docs/c4/images/house-management.erd.png "Диаграмма отношений сущностей")
